...
| 37 | P0 | [Antigravity/OpenCode] Gece Otonom Güvenlik Taraması — Security Cron & Audit Fix | `pnpm audit fix` ile tespit edilen 16 paket güvenlik açığını yamalamak ve otomatik tarama mekanizmasını kilit altına almak (Doktrin #037). **v12.17 — 🟡 KISMEN.** `45299e1` package override'ları eklendi; `pnpm audit` ölçümü: **1 high, 0 critical** (önceki tur 2 high idi). İyileşme gerçek ama hedef 0 high — PF-6 hâlâ kırmızı. | pending |
