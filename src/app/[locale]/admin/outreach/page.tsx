...
export default function OutreachPage() {
  ...
  const [activeTab, setActiveTab] = useState<"media" | "expert" | "plan">("media");
  ...
  return (
    <div className="space-y-6 p-6 pb-24">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-2xl font-bold tracking-tight text-white">{t("outreach_hub")}</h1>
          <p className="text-sm text-slate-400">Launch templates and communication strategy</p>
        </div>
      </div>
