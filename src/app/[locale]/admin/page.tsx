              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-2 gap-2 sm:grid-cols-3">
                  {[
                    ...
                    { href: `/${locale}/admin/resources`, label: "Resource Alloc", icon: Layers },
                    { href: `/${locale}/admin/ecosystem`, label: "Ecosystem Capital", icon: Globe },
                    {
              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-2 gap-2 sm:grid-cols-3">
                  {[
                    ...
                    { href: `/${locale}/admin/ai-pulse`, label: "AI Pulse Health", icon: Radio },
                    ...
                    { href: `/${locale}/admin/autopilot`, label: "Autopilot Core", icon: Workflow },
                    {
                    ...
                    { href: `/${locale}/admin/providers`, label: "AI Providers", icon: Sparkles },
                    {
                      href: `/${locale}/admin/cross-audit-dashboard`,
                      label: "Cross Audit",
                      icon: Eye,
                    },
                    { href: `/${locale}/admin/settings`, label: "Global Settings", icon: Database },
                  ].map((route) => (
                    <Link
                      key={route.href}
                      href={route.href}
              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-2 gap-2 sm:grid-cols-3">
                  {[
                    ...
                    { href: `/${locale}/admin/moderation`, label: "Moderation Queue", icon: Inbox },
                    { href: `/${locale}/admin/api-keys`, label: "API Key Management", icon: Key },
                    {
                    ...
                    { href: `/${locale}/admin/cockpit`, label: "Cockpit Control", icon: Sparkles },
                  ].map((route) => (
                    <Link
                      key={route.href}
                      href={route.href}
          ...
          <section className="group relative flex flex-col justify-between overflow-hidden rounded-3xl border border-purple-500/20 bg-zinc-900/40 p-6 backdrop-blur-xl transition-all duration-300 hover:border-purple-500/40 hover:bg-zinc-900/60 md:p-8">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-2 gap-2 sm:grid-cols-3">
                  {[
                    { href: `/${locale}/admin/master-plan`, label: "Master Plan", icon: FileText },
                    { href: `/${locale}/admin/strategy`, label: "Strategy Portal", icon: Target },
                    {
                    ...
                    { href: `/${locale}/admin/outreach`, label: "Outreach (Resend)", icon: Send },
                    { href: `/${locale}/admin/social`, label: "Social Media", icon: Globe },
                    { href: `/${locale}/admin/marketing`, label: "Growth Marketing", icon: Flame },
                    {
                    ...
                    { href: `/${locale}/admin/signals`, label: "Market Signals", icon: Activity },
                    {
