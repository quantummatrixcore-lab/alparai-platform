...
export const VENDORS: Vendor[] = [
  // 1. Infrastructure
  {
    ...
    criticality: "high",
    prosCons: {
      en: "Pro: High performance Edge deployment, unlimited crons, 300s serverless timeout, 1TB bandwidth, 12 concurrent builds.",
      tr: "Artı: Yüksek performanslı Edge dağıtımı, sınırsız cron, 300s sunucusuz işlem süresi, 1TB bant genişliği, 12 eşzamanlı derleme.",
    },
    alternatives: {
      en: "Netlify Pro ($19/mo, DNS changes required), Cloudflare Pages (Low cost, near-zero migration).",
      tr: "Netlify Pro ($19/ay, DNS değişikliği), Cloudflare Pages (Düşük maliyet, neredeyse sıfır göç).",
    },
  ...
  },
  {
    ...
    criticality: "high",
    prosCons: {
      en: "Pro: Production PostgreSQL database (no 7-day inactivity pause), 8GB DB, 100GB Storage, Custom Domain addon ($10/mo), Point-in-time recovery.",
      tr: "Artı: Kesintisiz üretim PostgreSQL veritabanı (7 gün inaktiflikte uykudan muaf), 8GB DB, 100GB Depolama, Özel Alan Adı ($10/ay), PITR yedekleme.",
    },
    alternatives: {
